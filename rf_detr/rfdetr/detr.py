...
from infer_rf_detr.rf_detr.rfdetr.config import RFDETRBaseConfig, RFDETRLargeConfig, TrainConfig, ModelConfig
from infer_rf_detr.rf_detr.rfdetr.main import Model, download_pretrain_weights
from infer_rf_detr.rf_detr.rfdetr.util.metrics import MetricsPlotSink, MetricsTensorBoardSink, MetricsWandBSink
    ...
    def predict(
        ...
        **kwargs,
        ...
        with torch.inference_mode():
            ...
            image = F.resize(
                image, (self.model.resolution, self.model.resolution))
