...
from infer_rf_detr.rf_detr.rfdetr.util.misc import NestedTensor, is_main_process

from infer_rf_detr.rf_detr.rfdetr.models.backbone.base import BackboneBase
from infer_rf_detr.rf_detr.rfdetr.models.backbone.projector import MultiScaleProjector
from infer_rf_detr.rf_detr.rfdetr.models.backbone.dinov2 import DinoV2
...
class Backbone(BackboneBase):
    ...
    def __init__(self,
        ...
        assert len(
            name_parts) == 2, "name should be dinov2, then either registers, windowed, both, or none, then the size"
        self.encoder = DinoV2(
            size=name_parts[-1],
        ...
        scale_factors = [level2scalefactor[lvl]
