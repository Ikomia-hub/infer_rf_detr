...
from infer_rf_detr.rf_detr.rfdetr.util.misc import NestedTensor
from infer_rf_detr.rf_detr.rfdetr.models.position_encoding import build_position_encoding
from infer_rf_detr.rf_detr.rfdetr.models.backbone.backbone import *
...
class Joiner(nn.Sequential):
    ...
    def forward(self, tensor_list: NestedTensor):
        ...
        pos = []
        for x_ in x:
            pos.append(self[1](x_, align_dim_orders=False).to(
                x_.tensors.dtype))
        return x, pos
